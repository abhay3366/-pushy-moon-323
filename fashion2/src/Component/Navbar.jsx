    ...
    <>
        ...
        <Flex  style={{fontSize:"12px",width:"90%",margin:"auto"}}>
            <Flex gap='5' justifyContent='space-around'  >
                <Box>
                    <Link to="../Routes/Offer.jsx">Offer</Link>
                </Box>
                <Box>
                    <Link to="../Routes/Fanbook.jsx">Fanbook</Link>
                </Box>
                <Box>
                    <Link to="../Routes/DownloadApp.jsx">Download App</Link>
                </Box>
                <Box>
                    <Link to="../Routes/Offer.jsx">TriBe Membership</Link>
                </Box>
            </Flex>
            <Spacer />
            <Flex gap='5'>
                <Box>
                    <Link to="../Routes/Contact.jsx">Contact Us</Link>
                </Box>
                <Box>
                    <Link to="../Routes/TrackOrder.jsx">Track Order</Link>
                </Box>
            </Flex>
